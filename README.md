...
اوضاع داشت بدتر میشد که UTF-8 ابداع شد.
 ...
 در یو تی اف هشت در واقع کد پوینت های بیت 0 تا 127 در یک بایت ذخیره میشدند، و از 128 به بالا در 2 و 3 و در واقع، تا 6 بایت ذخیره میشدند. با این نوع کد گذاری دیگه هیچ ساید افکتی متوجه کتاب های متنی انگلیسی نمیشد و آمریکایی ها متوجه هیچ خطایی نمیشدند. چرا؟ 
